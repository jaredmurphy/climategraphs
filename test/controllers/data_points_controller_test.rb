...
class DataPointsControllerTest < ActionController::TestCase
  ...
  test "should create data_point" do
    assert_difference('DataPoint.count') do
      post :create, data_point: { continent_id: @data_point.continent_id, value: @data_point.value, year: @data_point.year }
    end
  ...
  test "should update data_point" do
    patch :update, id: @data_point, data_point: { continent_id: @data_point.continent_id, value: @data_point.value, year: @data_point.year }
    assert_redirected_to data_point_path(assigns(:data_point))
  end
